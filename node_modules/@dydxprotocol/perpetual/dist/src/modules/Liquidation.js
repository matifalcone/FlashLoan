...
function makeLiquidateTradeData(amount, isBuy, allOrNothing) {
...
exports.makeLiquidateTradeData = makeLiquidateTradeData;
var Liquidation = /** @class */ (function () {
    function Liquidation(contracts) {
        this.contracts = contracts;
        this.liquidation = this.contracts.p1Liquidation;
    }
    Object.defineProperty(Liquidation.prototype, "address", {
        get: function () {
    ...
    Liquidation.prototype.trade = function (sender, maker, taker, price, amount, isBuy, allOrNothing, traderFlags, options) {
        if (allOrNothing === void 0) { allOrNothing = false; }
        if (traderFlags === void 0) { traderFlags = Constants_1.INTEGERS.ZERO; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.contracts.call(this.liquidation.methods.trade(sender, maker, taker, price.toSolidity(), makeLiquidateTradeData(amount, isBuy, allOrNothing), BytesHelper_1.bnToBytes32(traderFlags)), options)];
            });
        });
    };
    return Liquidation;
